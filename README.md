...
| 🤖 **AI Sales Pitch** | Personalized HPE enterprise pitch generated by a CrewAI agent (150–350 words) |
| 📦 **Product Recommendations** | RAG-matched products from an internal portfolio catalog |
...
**📡 Live Streaming**
The `/api/v1/analyze/stream` endpoint streams Llama 3 tokens in real time via Server-Sent Events, allowing the UI to display the sales pitch as it's being written.
...
Built with Python, React, CrewAI, and Llama 3 · Designed for enterprise sales teams
